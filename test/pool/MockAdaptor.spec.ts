...
describe('MockAdaptor', function () {
  ...
  beforeEach(async function () {
    ...
    await pool0.connect(owner).setCrossChainHaircut(parseEther('0.004'))
    await pool1.connect(owner).setCrossChainHaircut(parseEther('0.004'))
    await pool0.setMaximumNetMintedCredit(parseEther('100000'))
    await pool1.setMaximumNetMintedCredit(parseEther('100000'))
