...
import { BNBX_POOL_TOKENS_MAP } from '../tokens.config'
import { logVerifyCommand } from '../utils'

const contractName = 'BnbxPool_Assets'
const poolContractName = 'BnbxPool'
const assetContractPrefix = 'Asset_BnbxPool_'
...
const deployFunc: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  console.log(`Step 033. Deploying on : ${hre.network.name} with account : ${deployer}`)
