...
runScript('AdjustEmissionDistribution', async () => {
  ...
  if (network == Network.ARBITRUM_MAINNET) {
    WOM_MONTHLY_EMISSION_RATE = 1700000
    BRIBE_ALLOC_PERCENT = 45
    GAUGE_ALLOC_PERCENTS = {
      // Main Pool
      Asset_P01_USDC: 26.25,
      Asset_P01_USDT: 20.6,
      Asset_P01_DAI: 5.65,
      // wmxWOM Pool
    ...
    WOM_MONTHLY_EMISSION_RATE = 2000000
    BRIBE_ALLOC_PERCENT = 62.5
    GAUGE_ALLOC_PERCENTS = {
      // Main Pool
      Asset_P01_USDC: 15.5,
      Asset_P01_USDT: 15.5,
      ...
      // wBETH Pool
      Asset_wBETH_Pool_wBETH: 1.5,
      Asset_wBETH_Pool_ETH: 0.5,
    }
  }
