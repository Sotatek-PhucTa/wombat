...
runScript('operation-20230816', async () => {
  ...
  if (network == Network.BSC_MAINNET) {
    ...
    return concatAll(
      ...
      ...multisig.utils.topUpMultipleEpochs('MultiRewarderPerSec_V3_Asset_ETHx_Pool_WETH', Token.WOM, 3),
      ...multisig.utils.topUpMultipleEpochs('MultiRewarderPerSec_V3_Asset_ETHx_Pool_ETHx', Token.WOM, 3),
      // Lido wstETH
      // top up 3 weeks worth of emission
      ...multisig.utils.topUpMultipleEpochs('MultiRewarderPerSec_V3_Asset_wstETH_Pool_WETH', Token.WOM, 3),
      ...multisig.utils.topUpMultipleEpochs('MultiRewarderPerSec_V3_Asset_wstETH_Pool_wstETH', Token.WOM, 3),
      // agEUR
      ...
      // top up 3 weeks worth of emission
      ...multisig.utils.topUpMultipleEpochs('MultiRewarderPerSec_V3_Asset_agEUR_Pool_EURe', Token.WOM, 3),
      ...multisig.utils.topUpMultipleEpochs('MultiRewarderPerSec_V3_Asset_agEUR_Pool_agEUR', Token.WOM, 3),
      // frxETH
